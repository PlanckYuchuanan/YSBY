...
### point_transactions / points_records 积分记录表
...
| amount | BIGINT | 变动积分（正=增加, 负=减少） |
| type | VARCHAR(50) | 变动类型：sign/video/like/comment/exchange/purchase |
| description | VARCHAR(255) | 描述 |
| related_id | VARCHAR(36) | 关联业务 ID（如视频 ID、订单 ID） |
| created_at | DATETIME | 创建时间 |
